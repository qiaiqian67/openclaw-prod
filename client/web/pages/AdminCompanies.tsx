...
export default function AdminCompanies() {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', height: 'calc(100vh - var(--titlebar-height) - 64px)' }}>
...
function PlatformTab() {
    ...
    const [systemEmailConfig, setSystemEmailConfig] = useState({
        ...
        SYSTEM_EMAIL_FROM_NAME: 'DeerClaw',
        SYSTEM_SMTP_HOST: '',
            ...
            .then(d => {
                if (d?.value) {
                    setSystemEmailConfig({
                        ...
                        SYSTEM_EMAIL_FROM_NAME: d.value.SYSTEM_EMAIL_FROM_NAME || 'DeerClaw',
                ...
                <div style={{ marginBottom: '16px', background: 'var(--bg-secondary)', padding: '12px', borderRadius: '8px', border: '1px solid var(--border-subtle)' }}>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder={t('admin.ssoDomainPlaceholder', 'e.g. acme.deerclaw.com')}
                            style={{ fontSize: '13px' }}
                        />
                    </div>
                </div>
