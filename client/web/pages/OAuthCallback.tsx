...
export default function OAuthCallback() {
    ...
    if (tenants) {
        return (
            <div style={{
                ...
                justifyContent: 'center', height: 'calc(100vh - var(--titlebar-height))', padding: '20px',
            }}>
                <div style={{
                    background: '#fbfbfa',
                    borderRadius: '16px',
    ...
    // ── Loading state ────────────────────────────────────────────────
    return (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: 'calc(100vh - var(--titlebar-height))', padding: '20px', textAlign: 'center' }}>
