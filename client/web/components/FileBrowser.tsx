...
export default function FileBrowser({
    ...
    const reload = useCallback(async () => {
        ...
        try {
            ...
            // Some backends return a non-array (object / null) on 4xx wrapped
            // in a 200, or when an adapter gets the wrong shape. Treat anything
            // non-array as empty so the file list never crashes with
            // "files.map is not a function" inside the ErrorBoundary.
