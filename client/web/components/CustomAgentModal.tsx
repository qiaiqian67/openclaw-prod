...
function buildOpenClawInstruction(apiKey: string) {
    ...
    return `Please create a skill file at skills/deerclaw_sync.md with the following content, then add "Check DeerClaw inbox using the deerclaw_sync skill and process any pending messages" to your HEARTBEAT.md:
