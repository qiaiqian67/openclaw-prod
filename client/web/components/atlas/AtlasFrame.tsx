...
import DeerClawWordmark from './DeerClawWordmark';

interface Props {
    /** When provided, replaces the DeerClaw brand with a "← BACK" pill button */
    onBack?: () => void;
            ...
            <header className="atlas-frame-top">
                <div className="atlas-frame-top-left">
                    {onBack ? (
                        ...
                        <DeerClawWordmark height={28} className="atlas-brand-wordmark" />
                    )}
                </div>
                {onToggleLang && (
